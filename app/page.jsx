...
export default async function Home() {
  ...
  // console.log("🚀 ~ file: page.jsx:24 ~ Home ~ data1:", data1);
  // const [data2, setData2] = useState([]);
  // console.log("🚀 ~ file: page.jsx:26 ~ Home ~ data2:", data2);
  // const [data3, setData3] = useState([]);
  // console.log("🚀 ~ file: page.jsx:28 ~ Home ~ data3:", data3);
  // const [data4, setData4] = useState([]);
  // console.log("🚀 ~ file: page.jsx:30 ~ Home ~ data4:", data4);
  // const [data5, setData5] = useState([]);
  // console.log("🚀 ~ file: page.jsx:32 ~ Home ~ data5:", data5);
  // const [data6, setData6] = useState([]);
  // console.log("🚀 ~ file: page.jsx:34 ~ Home ~ data6:", data6);
